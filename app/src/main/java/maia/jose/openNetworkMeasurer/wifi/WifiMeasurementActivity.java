...
public class WifiMeasurementActivity extends AppCompatActivity implements
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        LocationListener {

    private String LOG_TAG = WifiMeasurementActivity.class.getSimpleName();
    private GoogleApiClient mGoogleApiClient;
    private WifiMeasurementFragment frag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wifi_measurement);
        ...
        if (savedInstanceState == null) {
            frag = new WifiMeasurementFragment();
